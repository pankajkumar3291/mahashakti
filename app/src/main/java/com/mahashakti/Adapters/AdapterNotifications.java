...
public class AdapterNotifications extends RecyclerView.Adapter<AdapterNotifications.MyHolder> {
    ...
    public void onBindViewHolder(AdapterNotifications.MyHolder holder, int position) {
        ...
        System.out.println("AdapterNotifications.onBindViewHolder - - texMessageName  - " + holder.txtMessageName);
        System.out.println("AdapterNotifications.onBindViewHolder - - txtMessageDesc  - " + holder.txtMessageDesc);
