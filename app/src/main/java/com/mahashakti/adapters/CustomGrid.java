...
public class CustomGrid extends BaseAdapter {
    ...
    private  ArrayList<PayloadGallery> payloadGalleryArrayList = new ArrayList<>();


    public CustomGrid(Context mContext,ArrayList<PayloadGallery> payloadGalleryArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PayloadGallery payloadGallery = payloadGalleryArrayList.get(position);
        ...
        if(convertView ==null){
           ...
           // textView.setText(payloadGallery.getImagedesc());
            ...
            Picasso.with(mContext)
                    .load(getYoutubeThumbnailUrlFromVideoUrl(payloadGallery.getVideourl()))
                    .error(R.drawable.user)
                    .into(imageView);
